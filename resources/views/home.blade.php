...
<head>
    ...
    <title>Red de Aulas Talleres Móviles </title>
...
<body class="antialiased">
    ...
    <main>
        <div class="centerHorizontally homeContainer">
            ...
            <h3 class="contentTitle">Nuestra Historia</h3>
                <p>
                    ...
                    el Consejo Federal de Educación (CFE), surgió en el año 2012 ante la necesidad de asegurar espacios
                    de formación y capacitación a personas que residen alejadas de los centros urbanos (y que, de otra
                    manera, no hubieran podido acceder, quedando fuera del sistema educativo y del trabajo); velando así por
                    el aseguramiento de una educación inclusiva y de calidad en todo el territorio argentino.
                </p>
            </div>
            ...
            <div class="card blue">
                ...
                <p>
                    ...
                    equipamiento requeridos para tal fin, según la especialidad técnica atendida: 
                    <ul>
                ...
                <div class="centerHorizontally">
                    <a class="ctoBtn" href="/list">Ver Lista de Aulas Móviles</a>
                </div>
            </div>
            ...
            <div class="card white">
                ...
                <p>
                    ...
                    la importancia de su rol educativo en la comunidad siendo evidenciada en los miles de egresados en
                    todo el país que hoy pueden desarrollar oficios de los más variados en la Industria Argentina; como así
                    también, en los técnicas y técnicos, profesionales, docentes e instructores de la Educación Técnico
                    Profesional que cursan diversos trayectos de formación continua, lo cual asegura el cumplimiento de la Ley
            ...
            <div class="card blue">
                ...
                <p>
                    ...
                    y, debido al carácter evolutivo y la demanda social creciente vinculada a las ATMs y sus diversas ofertas
                    formativas, el Ministerio de Educación de la Nación amplió el presente programa.
                </p>

                <div class="centerHorizontally">
                    <a class="ctoBtn" href="/map">Ver Mapa de Aulas Móviles</a>
                </div>
            </div>
            ...
            <div class="card white">
                ...
                <p>
                    ...
                    un uso responsable del recurso existente y de las futuras nuevas 50 ATM en pronta licitación.
                </p>
            </div>
        </div>
    </main>
