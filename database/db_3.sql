...
INSERT INTO  ubicacion_aula_x_fecha (n_aula_movil, fecha_inicio, fecha_fin, longitud, latitud, localidad, provincia, codigo_postal) VALUES ('24', '2023-10-28', '2023-11-30', '-36.6769815180527', '-60.5988319815719', 'Villa Urquiza', 'Buenos Aires', '7600');
INSERT INTO  ubicacion_aula_x_fecha (n_aula_movil, fecha_inicio, fecha_fin, longitud, latitud, localidad, provincia, codigo_postal) VALUES ('29', '2023-10-28', '2023-11-30', '-36.7769015180527', '-60.5088319815719', 'Caballito', 'Buenos Aires', '7600');
...
INSERT INTO  ubicacion_aula_x_fecha (n_aula_movil, fecha_inicio, fecha_fin, longitud, latitud, localidad, provincia, codigo_postal) VALUES ('90', '2023-10-28', '2023-11-30', '-28.7743047046407', '-57.8012191977913', 'General Alvear', 'Corrientes', '3400');
...
(24, 'Instalaciones domiciliarias', 'Instalaciones de aires acondicionados', 'Aprende todo lo necesario para instalar aires acondicionados de la mano de tres expertos. \nDuración  3 meses\nModalidad  presencial', '2024-03-05', '2023-06-05');

INSERT INTO oferta_formativa (n_aula_movil, familia_profesional, nombre, descripcion, fecha_inicio, fecha_fin) VALUES
(29, 'Informática, redes y reparación de PC', 'Linux inicial', 'Aprende todo lo necesario para instalar aires acondicionados de la mano de tres expertos. \nDuración  3 meses\nModalidad  presencial', '2024-03-05', '2023-06-05');

INSERT INTO oferta_formativa (n_aula_movil, familia_profesional, nombre, descripcion, fecha_inicio, fecha_fin) VALUES
(90, 'Soldadura', 'Soldaduras inicial', 'Aprende todo lo necesario para instalar aires acondicionados de la mano de tres expertos. \nDuración  3 meses\nModalidad  presencial', '2024-03-05', '2023-06-05');

INSERT INTO oferta_formativa (n_aula_movil, familia_profesional, nombre, descripcion, fecha_inicio, fecha_fin) VALUES
(90, 'Genérica', 'Fisica y matemáticas', 'Aprende todo lo necesario para instalar aires acondicionados de la mano de tres expertos. \nDuración  3 meses\nModalidad  presencial', '2024-03-05', '2023-06-05');

INSERT INTO oferta_formativa (n_aula_movil, familia_profesional, nombre, descripcion, fecha_inicio, fecha_fin) VALUES
(90, 'Metalmecánica', 'Mecánica de monster trucks', 'Aprende todo lo necesario para instalar aires acondicionados de la mano de tres expertos. \nDuración  3 meses\nModalidad  presencial', '2024-03-05', '2023-06-05');
